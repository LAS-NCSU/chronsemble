...
function init() {
    ...
    d3.csv(sourceFile, function (dataset) {
        timelineInit(domElement, sourceFile)
            .data(dataset)
            .band("mainBand", 0.82)
            .band("naviBand", 0.08)
            .xAxis("mainBand")
...
function loaded(values) {
    var division = document.getElementById("preview-coverflow");
    values.forEach(function (items) {
        var imageCF = document.createElement("img");
        imageCF.setAttribute('class', 'cover');
        /*imageCF.setAttribute('src', 'https://static.pexels.com/photos/33109/fall-autumn-red-season.jpg');*/
        imageCF.width = '150';
        imageCF.height = '100';
        imageCF.setAttribute('alt',items.label);
        imageCF.style.border='2px solid #E8272C';
        division.appendChild(imageCF);
    });
}
...
function timelineInit(domElement, source) {
    ...
    var fo1 = group1.append("foreignObject")
        .attr("width", 20)
        .attr("height", 20)
        .attr("class", "fo")
        .attr("y", 0);
    ...
    var fo2 = group2.append("foreignObject")
        .attr("width", 20)
        .attr("height", 20)
        .attr("class", "fo")
        .attr("y", 70);
