...
function timelineAddition(domElement, random, source) {
    ...
    var timelineAddition = {},   // The timelineAddition
        data = {},       // Container for the data
        components = [], // All the components of the timelineAddition for redrawing
        bandGap = 25,    // Arbitray gap between to consecutive bands
        bands = {},      // Registry for all the bands in the timelineAddition
    ...
    var svg = dom.select('#philosophers.csv').append("svg")
        .attr("class", "svg")
        .attr("id", res[pos])
